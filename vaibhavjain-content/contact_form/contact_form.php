...
// configure
$from = 'vaibhav.jain@windowslive.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'vaibhav.jain@windowslive.com'; // Replace it with Your email. REQUIRED!
